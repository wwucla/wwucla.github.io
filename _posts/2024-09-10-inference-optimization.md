...
**TL;DR**: this note lays out an overview and challenges of LLM inference, and how those challenges can be overcome by optimizing the algorithm of engineering implementation.
